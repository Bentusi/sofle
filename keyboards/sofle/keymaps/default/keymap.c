...
[_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,    KC_SLEP, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                 KC_LGUI,KC_LALT,KC_LCTRL,KC_LOWER, KC_SPC,      KC_SPC,KC_RAISE, KC_GRV, KC_RALT, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______,  XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, _______,       _______, KC_1, KC_2, KC_3, KC_0, KC_BSLS, _______, \
 ...
 * | Esc  |      |      |      |      |      |                    |      |      |      |      |      |  Del |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |      | PREV | PLAY | NEXT |      |                    |      | PWrd |  Up  | NWrd |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT( \
  ...
  _______, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT,  XXXXXXX,                          XXXXXXX, KC_PRVWD, KC_UP,   KC_NXTWD, KC_DLINE, XXXXXXX, \
  _______, KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX,  KC_HOME,                          KC_PGUP, KC_LEFT,  KC_DOWN, KC_RGHT,  XXXXXXX,  XXXXXXX, \
